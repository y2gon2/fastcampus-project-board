...
class ArticleServiceTest {
    ...
    @Test
    void givenNoSearchParameters_whenSearchingArticlesViaHashtag_thenReturnsEnmptyPage() {
        // Given
        Pageable pageable = Pageable.ofSize(20);
    ...
    @Test
    void givenNonexistenceHashtag_whenSearchingArticlesViaHashtag_thenReturnsEmptyPage() {
        // Given
        String hashtagName = "난 없지롱";
        Pageable pageable = Pageable.ofSize(20);
        given(
                articleRepository.findByHashtagNames(List.of(hashtagName), pageable)
    ...
    @Test
    void givenModifiedInfoWithDifferentUser_whenUpdatingArticle_thenDoesNothing() {
        // Given
        ...
        given(articleRepository.getReferenceById(differentArticleId))
                .willReturn(differentArticle);
